...
namespace UcuzSepet.Data.Domain.Migrations
{
    ...
    [Migration("20190908082714_Added-Order-Table-to-Status-Column")]
    partial class AddedOrderTabletoStatusColumn
    {
            ...
            modelBuilder.Entity("UcuzSepet.Data.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("UcuzSepet.Data.Domain.Entities.Category", "Category")
                        .WithMany()
